...
### Historical Context
Deployed during the Frontier era, Etherboard was one of the earliest "million pixel" experiments on Ethereum, predating similar concepts by years. The Reddit announcement from November 2015 describes it as "an image powered by the blockchain." Source code was preserved in a GitHub repository by Alex Beregszaszi (axic.eth), co-lead of the Solidity compiler.

## Sources
- [GitHub: axic/etherboard](https://github.com/axic/etherboard) (source preserved by axic.eth)
...
- [Wayback Machine: etherboard.io/contract](https://web.archive.org/web/20160328160405/http://etherboard.io/contract)
